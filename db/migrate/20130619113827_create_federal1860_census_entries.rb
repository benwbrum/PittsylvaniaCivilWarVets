class CreateFederal1860CensusEntries < ActiveRecord::Migration
  def change
    create_table :federal1860_census_entries do |t|
      t.integer :id
      ...
      t.boolean :member_of_veteran_household
